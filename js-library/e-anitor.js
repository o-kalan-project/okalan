...
function _makechart(where,title,index,animation){
	_id(where).innerHTML+="<dt style='font-size:30px;color:white;font-family:keifont'class="+animation+">"+title+"</dt><dd><h2 style='font-size:25px;font-weight:5;'class="+animation+">"+index+"</h2></dd>"
}
