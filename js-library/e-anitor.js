...
async function _goto3(where){$('#hide2, #aa, #text, #prof').fadeOut(300);await _sleep(550);window.location.href=where}
...
function _makechart(where,title,index,animation){
	_id(where).innerHTML+="<dt style='font-size:30px;color:white;font-family:keifont;'class="+animation+">"+title+"</dt><dd><h2 style='font-size:25px;font-weight:5;color:pink;font-family:keifont;'class="+animation+">"+index+"</h2></dd>"
}
